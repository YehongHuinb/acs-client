!<template>
  <div class="markTestPaper testPaper app-container">
    <div class="w">
      <!-- 考试信息 -->
      <div class="title">
        ...
        <ul>
          <li class="user-info">所属班级: {{ testData.userGrade.classesName }}</li>
      ...
      <div class="title fixed" v-if="isFixed">
        <ul>
          <li class="test-info">
            <strong class="testName">{{ testData.name }}</strong>
          </li>
          <li class="test-info">总分: {{ testData.totalScore }} 分</li>
              ...
              <ul>
                ...
                >
                  ...
                  <div class="left">
                    ...
                    <div
                      v-if="t.topicType == 3 || t.topicType == 4"
                      class="correctAnswer"
                    >
                  ...
                  <div class="right">
                    <div
                      v-if="
                        t.topicType == 0 || t.topicType == 1 || t.topicType == 2
                      "
                    >
                      <div class="correctAnswer">
                        参考答案: {{ correctOptions(t) }}
                      </div>
        ...
        >
          ...
          >
            <div class="topic-nav-item" v-if="topics.topic_content.length != 0">
              <div class="nav-title">
                {{ topicTypeName_mixin(topics.topic_type) }}
              </div>

              <span
                class="topic-nav-button"
                @click="topicNav(topics.topic_type, index)"
...
import "@/assets/styles/correction-exam.scss";
import examProfile from "@/mixins/examProfile-mixins";
import { getUserExam, markExam } from "@/api/exam";
...
export default {
  ...
  methods: {
    ...
    submitExam() {
      ...
      this.testData.topics.forEach((item) => {
